                    ...
                    <div class="col-12">
                        <section class="items">
                            <form method="post" action="loginPage.php">
                                <p>
                                    Username:
                                    <input type="text" class="form-control form-rounded" name="username" />
                                </p>
                                <p>
                                    Password:
                                    <input type="password" class="form-control form-rounded" name="password" />
                                </p>
                                <p>
                                    <input type="submit" name="login_user" class="btn" value="Login" style="color: white; background-color: #80b444" />
                                </p>
                            </form>
                        </section>
                    </div>
                    ...
                    <div class="col-12">
                        <section class="items">
                            <form method="post" action="loginPage.php">
                                ...
                                <p>
                                    <input type="submit" name="login_user" class="btn btn-warning" value="Login" style="color: white; background-color: #80b444" />
                                </p>
                            </form>
                        </section>
                    </div>
