...
<body class="container-fluid">
    ...
    <section class="items row" style="margin: 0 10%;">
        <?php
        ...
        function printHome(){
            ...
            function printItems(){
                ...
                $sql = "SELECT * FROM booking WHERE student_num = $studentNum;"; 
                ...
                if (!$result) {
                    ...
                    echo("<table>
                    <tr>
                        <th scope='col' style='padding-left: 5vw; padding-right: 5vw; padding-bottom: 2vh;'> Booking Name </th>
                        <th scope='col' style='padding-left: 5vw; padding-right: 5vw; padding-bottom: 2vh;'> Date </th>
                        <th scope='col' style='padding-left: 5vw; padding-right: 5vw; padding-bottom: 2vh;'> Time </th>
                        <th scope='col' style='padding-left: 5vw; padding-right: 5vw; padding-bottom: 2vh;'> Email </th>
                        <th scope='col' style='padding-left: 5vw; padding-right: 5vw; padding-bottom: 2vh;'> Mobile Number </th>
                    </tr>");
                        for($x = 0; $x < $result->num_rows; $x++){
                            while ($row = mysqli_fetch_assoc($result)){
                                echo("<tr>
                                    <th scope='row'> ".$row['booking_name']."</th>
                                    <td> ".$row['booking_date']." </td>
                                    <td> ".$row['booking_time']." </td>
                                    <td> ".$row['booking_email']." </td>
                                    <td> ".$row['booking_mobileNum']." </td>
                                </tr>");
                        }
                    }
                }
