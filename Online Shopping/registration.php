...
//---------------------
    ...
    if( !empty($_POST['cust_photo']) && !empty($_POST['cust_photo']) ) {
        if($_POST['cust_photo'] != $_POST['cust_photo']) {
            $valid = 0;
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="col-md-6 form-group">
                                    ...
                                    <input type="file" class="form-control" name="cust_photo" value="<?php if(isset($_POST['cust_photo'])){echo $_POST['cust_photo'];} ?>">
                                </div>
                                <div class="col-md-6 form-group">
                                    <label for=""> ...</label>
                                    <input disabled type="line" class="form-control" name="">
                                </div>
