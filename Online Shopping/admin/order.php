...
?>
<link rel="stylesheet" type="text/css" href=https://https://cdnjs.cloudflare.com/ajax/libs/twitter-bootstrap/5.0.1/css/bootstrap.min.css>
<link rel="stylesheet" type="text/css" href="https://cdn.datatables.net/v/bs5/dt-1.13.4/b-2.3.6/b-html5-2.3.6/datatables.min.css">
<link rel="stylesheet" href="snap.css" media="print">
    ...
    <div class="col-md-12">
      ...
      <div class="box box-info">
        ...
        <div class="box-body table-responsive">
            ...
            <tbody>
            	...
            	foreach ($result as $row) {
					...
					<tr class="<?php if($row['payment_status']=='Pending'){echo 'bg-r';}else{echo 'bg-g';} ?>">
                        ...
                        <td>Php<?php echo $row['paid_amount']; ?></td>
                        <td>
          ...
          <button id="print-btn" onclick="window.print();" class="btn btn-danger myButton">Print</button>
        </div>
      </div>
