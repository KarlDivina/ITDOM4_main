						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr class="<?php if($row['cust_status']==1) {echo 'bg-g';}else {echo 'bg-r';} ?>">
									...
									<td style = "width:82px;">
										<img src="../assets/uploads/<?php echo $row['cust_photo']; ?>" alt="<?php echo $row['cust_email']; ?>" style ="width:82px;">
									</td>
									...
									<td>
									    <!-- <a href="Online Shopping\customer-profile-update.php?id=<?php echo $row['id']; ?>" class="btn btn-primary btn-xs">Edit</a> -->
