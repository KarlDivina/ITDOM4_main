...
<link rel="stylesheet" href="css/productbg.css">
					...
					<thead class="thead-dark">
						...
						<tbody>
							...
							foreach ($result as $row) {
								...
								<tr>
									<td><?php echo $i; ?></td>
									<td ><img style=" width: 82px; height: 82px; border-radius: 30px;box-shadow: 0 0 20px 2px rgba(0,0,0,.3);transition: .5s;" src="../assets/uploads/<?php echo $row['p_featured_photo']; ?>" alt="<?php echo $row['p_name']; ?>" style="width:80px;"></td>
									<td><?php echo $row['p_name']; ?></td>
									<td>Php<?php echo $row['p_old_price']; ?></td>
									<td>Php<?php echo $row['p_current_price']; ?></td>
