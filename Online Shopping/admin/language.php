  ...
  <div class="row">
    <div class="col-md-12">
        ...
        <div class="box box-info">
            <div class="box-body">
				<div class="form-group">
                    <label for="" class="col-sm-4 control-label">Orders/Receipt <span>*</span></label>
                    <div class="col-sm-6">
        ...
        <div class="box box-info">
            <div class="box-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-4 control-label">Admin Login <span>*</span></label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="lang_value[165]" value="<?php echo $lang_ids[165]; ?>">
                    </div>
                </div>			
				<div class="form-group">
