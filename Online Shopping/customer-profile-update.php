...
if (isset($_POST['form1'])) {
    ...
    if($valid == 1) {
        ...
        $statement = $pdo->prepare("UPDATE tbl_customer SET cust_name=?, cust_cname=?, cust_phone=?, cust_country=?, cust_address=?, cust_city=?, cust_state=?, cust_zip=?, cust_photo=? WHERE cust_id=?");
        ...
        $_SESSION['customer']['cust_photo'] = $_POST['cust_photo'];
    }
}
?>
                    ...
                    <form action="" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-sm-6" style="padding-top:6px;">
                                <label for=""><?php echo LANG_VALUE_164; ?> *</label>
                                <input type="file" name="cust_photo" value="<?php echo $_SESSION['customer']['cust_photo']; ?>">
